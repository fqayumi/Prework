...
public class Validator {
    ...
    public static String getString(Scanner sc, String prompt, String s1, String s2, String s3) {
        System.out.print(prompt);
        String s = sc.nextLine();  // read user entry
        while ( (!s.equalsIgnoreCase(s1)) && (!s.equalsIgnoreCase(s2)) && (!s.equalsIgnoreCase(s3)) ) {
        	//sc.nextLine();
    ...
    public static String getString(Scanner sc, String prompt, String s1, String s2) {
        System.out.print(prompt);
        String s = sc.nextLine();  // read user entry
        while ( (!s.equalsIgnoreCase(s1)) && (!s.equalsIgnoreCase(s2)) ) {
        	//sc.nextLine();
        	System.out.println("Please enter R to play Randy or L to play Lemmy.");
